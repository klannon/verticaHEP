 ...
 */
class Mult2Floats : public ScalarFunction
{
public:
                              ...
                              BlockWriter &resWriter)
    {
        try {
            ...
            do {
                const vfloat a = argReader.getFloatRef(0);
                const vfloat b = argReader.getFloatRef(1);
                resWriter.setFloat(a*b);
                resWriter.next();
...
class Mult2FloatsFactory : public ScalarFunctionFactory
{
    // return an instance of Add2Ints to perform the actual addition.
    virtual ScalarFunction *createScalarFunction(ServerInterface &interface)
    { return vt_createFuncObject<Mult2Floats>(interface.allocator); }
...
RegisterFactory(Mult2FloatsFactory);
